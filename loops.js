//1. Build a function forLoop. It takes an array as an argument.
...
function forLoop(array) {
  for (let i = 0; i < 25; i++){
    array.push(`I am ${i === 0 ? '' : 's'}.`)
  }
  return array
}

// 2. Create a function called whileLoop in loops.js.
//The function should take a number as an argument.
//Using a while loop, count down (using console.log) from the
...
// 3. Define a function called doWhileLoop in loops.js.
...
// and remove elements from the array until the array is empty or until maybeTrue()
// returns false. (Your condition might look something like array.length > 0 && maybeTrue().)
